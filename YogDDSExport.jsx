...
function savedds(ddsformat)
{
	...
	// Fallout Nrm Spec Gloss (BC5)
	// Fallout Color (BC1)
	if (ddssuffix == '_s' || ddssuffix == '_n') {
		var ddsformat = "Fallout Nrm Spec Gloss (BC5)";
	}
	else if (ddssuffix == '_d') {
		// if the PSD has an alpha channel, save it in the diffuse DDS
		if (alphaChan == 0) {
